...
``` {r}
# heatmap(cor(nba_processed[, sapply(nba_processed, is.numeric)], use = "complete.obs"))
# corrplot(cor(nba_processed[, sapply(nba_processed, is.numeric)], use = "complete.obs"), method = "color")
