...
```{r}
# Checking for colinearity between Three Pointers Attempted and Two Pointer Attempts
plot_corr(nba_processed, "Three Pointers Attempted", "Two Pointer Attempts")
```
