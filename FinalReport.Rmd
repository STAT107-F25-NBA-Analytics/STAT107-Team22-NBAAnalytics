...
![](img/plots/Three_Pointers_Attempted_vs_Two_Pointer_Attempts.png)
...
Similarly, ince three pointers and two-point shots are necessarily made during offensive drives, there is concern about colinearity between the successful attempts since they occupy the same production space. As a result, we will test for colinearity between the two.

![](img/plots/Three_Pointers_Made_vs_Two_Pointers_Made.png)
...
![](img/plots/Free_Throws_Attempted_vs_Personal_Fouls_Drawn.png)
...
![](img/plots/Assists_vs_Two_Pointers_Made.png)
...
![](img/plots/Assists_vs_Three_Pointers_Made.png)
...
![](img/plots/Blocks_vs_Personal_Fouls.png)

$$\rho = 0.008$$

![](img/plots/Steals_vs_Personal_Fouls.png){fig.pos='!H' width=75%}
