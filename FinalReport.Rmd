...
As a result, we naturally expect to see that offensive metrics have stronger associations to winning. While the data does seem to corroborate this intuition, especially when a Spearman test is applied, some of the data visually doesn't look strongly associated despite the Spearman test saying otherwise.

![](img/plots/Three_Point_Volume_Winningness-For-Props.png)
\begin{center}
$3x^2$
